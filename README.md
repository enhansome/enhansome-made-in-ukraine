...
* **[JavaScript Algorithms and Data Structures](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,777 | 🐛 407 | 🌐 JavaScript | 📅 2026-07-26** by [Oleksii Trekhleb](https://github.com/sponsors/trekhleb)<br>
  📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings

## > 50K ⭐️

* **[Ansible](https://github.com/ansible/ansible) ⭐ 70,738 | 🐛 836 | 🌐 Python | 📅 2026-09-18** co-maintained by [Sviatoslav Sydorenko](https://github.com/sponsors/webknjaz) as a part of the Code Dev Team at [Red Hat](https://redhat.com)<br>
  Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain.

## > 10K ⭐️

* **[Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,635 | 🐛 578 | 🌐 JavaScript | 📅 2026-09-19** by [Volodymyr Agafonkin](https://github.com/sponsors/mourner)<br>
  🍃 JavaScript library for mobile-friendly interactive maps

* **[Ink](https://github.com/vadimdemedes/ink) ⭐ 39,912 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-19** by [Vadim Demedes](https://github.com/sponsors/vadimdemedes)<br>
...
* **[pnpm](https://github.com/pnpm/pnpm) ⭐ 36,568 | 🐛 1,099 | 🌐 Rust | 📅 2026-09-20** by [Zoltan Kochan](https://github.com/sponsors/zkochan)<br>
  📦🚀 Fast, disk space efficient package manager

* **[Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,823 | 🐛 2,036 | 🌐 TypeScript | 📅 2026-09-19** by [Andrii Sherman](https://github.com/sponsors/AndriiSherman) / [Aleksandr Blokh](https://github.com/sponsors/AlexBlokh) / [Dan Kochetov](https://github.com/sponsors/dankochetov)<br>
  TypeScript ORM for SQL databases designed with maximum type safety in mind

* **[AlgoVPN](https://github.com/trailofbits/algo) ⭐ 30,388 | 🐛 77 | 🌐 Python | 📅 2026-09-09** by [Jack Ivanov](https://github.com/sponsors/jackivanov) / [TrailOfBits](https://github.com/sponsors/trailofbits)\
  📝 Set up a personal VPN in the cloud at the push of a button

* **[redoc](https://github.com/Redocly/redoc) ⭐ 25,915 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-16** by [Roman Hotsiy](https://github.com/sponsors/RomanHotsiy)<br>
...
* **[Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,792 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2025-11-23** by [Oleksii Trekhleb](https://github.com/sponsors/trekhleb)<br>
...
* **[graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,345 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-17** maintained by [Ivan Goncharov](https://github.com/sponsors/IvanGoncharov)<br>
  A reference implementation of GraphQL for JavaScript.

* **[Playground and Cheatsheet for Learning Python](https://github.com/trekhleb/learn-python) ⭐ 18,297 | 🐛 43 | 🌐 Python | 📅 2026-04-06** by [Oleksii Trekhleb](https://github.com/sponsors/trekhleb)<br>
  📚 Playground and cheatsheet for learning Python. Collection of Python scripts that are split by topics and contain code examples with explanations.

* **[Mock Service Worker](https://github.com/mswjs/msw) ⭐ 18,208 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-18** by [Artem Zakharchenko](https://github.com/sponsors/kettanaito)<br />
  Seamless REST/GraphQL API mocking library for browser and Node.js.

* **[Aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,553 | 🐛 222 | 🌐 Python | 📅 2026-09-19** by [Andrew Svetlov](https://github.com/asvetlov) and [Sviatoslav Sydorenko](https://github.com/sponsors/webknjaz)<br>
  Asynchronous HTTP client/server framework for asyncio and Python

* **[YoutubeDownloader](https://github.com/Tyrrrz/YoutubeDownloader) ⭐ 16,239 | 🐛 25 | 🌐 C# | 📅 2026-09-11** by [Oleksii Holub](https://github.com/sponsors/tyrrrz)<br>
...
* **[Resilience4J](https://github.com/resilience4j/resilience4j) ⭐ 10,765 | 🐛 307 | 🌐 Java | 📅 2026-08-31** by [Bohdan Storohuk](https://github.com/sponsors/storozhukBM)<br>
  Fault tolerance library for Java

## > 5K ⭐️

* **[DiscordChatExporter](https://github.com/Tyrrrz/DiscordChatExporter) ⭐ 12,036 | 🐛 16 | 🌐 C# | 📅 2026-09-01** by [Oleksii Holub](https://github.com/sponsors/tyrrrz)<br>
  Exports Discord chat logs to a file.

* **[PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,471 | 🐛 272 | 🌐 Python | 📅 2026-09-19** by [Ivan Kravets](https://github.com/sponsors/ivankravets) <br>
...
* **[Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,028 | 🐛 19 | 🌐 C | 📅 2026-09-19** by [Volodymyr Shymanskyy](https://github.com/sponsors/vshymanskyy)<br>
  🚀 The fastest WebAssembly interpreter (and the most universal wasm runtime)

* **[FSNotes](https://github.com/glushchenko/fsnotes) ⭐ 7,496 | 🐛 2 | 🌐 Swift | 📅 2026-09-18** by [Oleksandr Glushchenko](https://github.com/sponsors/glushchenko) <br>
...
* **[jscpd](https://github.com/kucherenko/jscpd) ⭐ 6,244 | 🐛 42 | 🌐 Rust | 📅 2026-09-19** by [Andrey Kucherenko](https://github.com/sponsors/kucherenko)<br>
...
* **[MeetingBar](https://github.com/leits/MeetingBar) ⭐ 5,345 | 🐛 143 | 🌐 Swift | 📅 2026-08-17** by [Andrii Leitsius](https://github.com/sponsors/leits)<br>
...
* **[YoutubeExplode](https://github.com/Tyrrrz/YoutubeExplode) ⭐ 3,724 | 🐛 9 | 🌐 C# | 📅 2026-09-01** by [Oleksii Holub](https://github.com/sponsors/tyrrrz)<br>
...
* **[Earcut](https://github.com/mapbox/earcut) ⭐ 2,590 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04** by [Volodymyr Agafonkin](https://github.com/sponsors/mourner)<br>
...
* **[PyPUG](https://github.com/pypa/packaging.python.org) ⭐ 1,669 | 🐛 183 | 🌐 Python | 📅 2026-09-14** co-maintained by [Sviatoslav Sydorenko](https://github.com/sponsors/webknjaz) as a part of PyPA<br>
